# Executive-Communication-Framework — Prompt 模板
...
```
请基于以上上下文，执行【Executive-Communication-Framework】：
...
```
请为【Executive-Communication-Framework】生成准备清单：
