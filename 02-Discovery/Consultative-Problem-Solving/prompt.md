# Consultative-Problem-Solving — Prompt 模板
...
你的任务：用 Issue Tree + DIVE 将功能诉求转译为可验证业务问题
...
```
请基于以上上下文，执行【Consultative-Problem-Solving】：
...
```
请为【Consultative-Problem-Solving】生成准备清单：
