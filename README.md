...
02-Discovery           访谈、流程、咨询式拆解、预期管理、高层沟通、AIBP 协作
...
当前共 **28 个核心 Skill**，成熟度 `usable`。完整列表见 [`INDEX.md`](./INDEX.md)。
...
发现 → 02-Discovery（Consultative-Problem-Solving, Expectation-Management-Script）
